...
public:
  ...
  result<std::array<std::vector<std::string>,2>> feature_enum_info_get(const std::string_view & name) const;
  ...
  result<void> feature_raw_set(const std::string_view & name, const std::vector<uint8_t> buffer) const;
