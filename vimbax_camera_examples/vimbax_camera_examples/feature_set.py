...
from .helper import feature_type_dict
...
def main():
    ...
    response = single_service_call(node,feature_type.set_service_type,f"{args.node_name}/{feature_type.service_base_path}_set",request)
